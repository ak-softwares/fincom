...
class _SingleOrderScreenState extends State<SingleOrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppAppBar2(titleText: "Order #", showBackArrow: true, showSearchIcon: true, showCartIcon: true,),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Heading(
                              title: 'Order Items',
                              paddingLeft: AppSizes.defaultSpace),
                          GridLayout(
                            crossAxisCount: 1,
                            mainAxisExtent: 90,
