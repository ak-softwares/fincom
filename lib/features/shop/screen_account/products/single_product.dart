...
class _SingleProductState extends State<SingleProduct> {
  ...
  final productController = Get.put(ProductsVoucherController());
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(AppSettings.appCurrencySymbol + product.getPrice().toStringAsFixed(2), style: TextStyle(fontSize: 14))
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Total Stock:'),
                      Text(product.getTotalStock().toString(), style: TextStyle(fontSize: 14))
                    ],
                  ),
                ],
              ),
