...
class SyncProductScreen extends StatelessWidget {
  const SyncProductScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // Ensure the controller is initialized
    Get.put(SyncProductController());
  ...
  Widget _buildSyncOptionCard({
    ...
    return GetBuilder<SyncProductController>(
      builder: (controller) {
        return Card(
          elevation: 4,
                          ...
                          children: [
                            ...
                            if (title.contains('Add'))
                              IconButton(
                                ...
                                onPressed: isActive ? controller.getTotalProductsCount : null,
                              ),
                          ],
                        ),
                          ...
                          Obx(() {
                            if (controller.isGettingCount.value) {
                              ...
                              return Padding(
                                ...
                                child: Text(
                                  '${controller.newProductsCount} new products available',
  ...
  Widget _buildProgressSection(SyncProductController controller) {
    return Card(
      elevation: 4,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (controller.currentProductName.isNotEmpty)
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
  ...
  String _getStatusMessage(SyncStatus status) {
    switch (status) {
      ...
      case SyncStatus.fetching:
        return 'Fetching products from WooCommerce...';
      case SyncStatus.pushing:
